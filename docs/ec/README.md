...
|---|---|---|---|---|---|---|---|
| Intel Arc G3 Extreme | `ONEXPLAYER X2Mini`, `ONEXPLAYER X2`, `ONEXPLAYER X2 EVA`, `ONEXPLAYER 3`, `ONEXPLAYER Apex Air`, `ONEXPLAYER Apex i` | OxpWMI (`ecAccessType=2`) | `0x58`/`0x59` | `0xEB` | `0x4A`/`0x4B`, 0–184 | `0xA3`/`0xA4`/`0xA5` | [x2-mini.md](x2-mini.md) |
...
Shared on both maps: handle power `0x2D` (on=`1`, off=`0`), power-supply mode `0xE3`, TDP-able gate `0xED`, sensors `0x60`/`0x61`/`0x70`/`0xA0`/`0xA1`/`0xA2`.
