...
| Requested model | DMI / OneXConsole `Product` | Status |
|---|---|---|
| X2 Mini (Intel) | `ONEXPLAYER X2Mini` | Mapped |
| X2 Mini PRO (AMD) | `ONEXPLAYER X2Mini PRO` | Mapped |
| X2 Air | *no such product string* | See [x2-air.md](x2-air.md) |

OneXConsole 0.10.2-fix8 has **no** `X2 Air`, `X2Air`, or `ONEXPLAYER X2 Air` product name. The 2026 “Air” handheld in the same lineup is `ONEXPLAYER Apex Air`. The large 10.95" 3-in-1 is `ONEXPLAYER X2` / `ONEXPLAYER X2 EVA`. Both use the same Intel EC family as X2 Mini.
...
3. Two access backends (`ecAccessType`):
   ...
   - **2 = OxpWMI** (Intel X2 / X2 Mini / Apex Air): `ECOxpWMI`.
...
|---|---|---|---|---|---|
| Intel X2-class | X2 Mini, X2, X2 EVA, Apex i, Apex Air | `0x58`/`0x59` | `0xEB` | 0–184 | `0xA3`/`0xA4`/`0xA5` |
...
- [x2-air.md](x2-air.md) — X2 Air naming, plus X2 / Apex Air maps
